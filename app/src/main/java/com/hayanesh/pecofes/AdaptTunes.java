...
public class AdaptTunes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adapt_tunes);
        ...
        title = (TextView)findViewById(R.id.adapt_title);
        topic = (TextView)findViewById(R.id.adapt_topic);
        description = (TextView)findViewById(R.id.adapt_description);
        price = (TextView)findViewById(R.id.adapt_price);
        priceamt = (TextView)findViewById(R.id.adapt_priceamt);
        ...
        listView = (ListView)findViewById(R.id.adapt_abouttopic);
        String[] rules = getResources().getStringArray(R.array.adapt_rules);
