...
public class Choreonite extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_choreonite);
        ...
        title = (TextView)findViewById(R.id.choreonite_title);
        topic = (TextView)findViewById(R.id.choreonite_topic);
        description = (TextView)findViewById(R.id.choreonite_description);
        price = (TextView)findViewById(R.id.choreonite_price);
        priceamt = (TextView)findViewById(R.id.choreonite_priceamt);
        ...
        listView = (ListView)findViewById(R.id.choreonite_abouttopic);
        String[] rules = getResources().getStringArray(R.array.choreo_rules);
