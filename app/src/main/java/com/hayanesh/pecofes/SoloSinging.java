...
public class SoloSinging extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_solo_singing);
        ...
        title = (TextView)findViewById(R.id.solo_title);
        topic = (TextView)findViewById(R.id.solo_topic);
        description = (TextView)findViewById(R.id.solo_description);
        price = (TextView)findViewById(R.id.solo_price);
        priceamt = (TextView)findViewById(R.id.solo_priceamt);
        ...
        listView = (ListView)findViewById(R.id.solo_abouttopic);
        String[] rules = getResources().getStringArray(R.array.solo_rules);
        ...
        try{
            Glide.with(this).load(R.drawable.sing).into((ImageView)findViewById(R.id.solo_thumbnail));
        }catch (Exception e)
        {
            e.printStackTrace();
        }
