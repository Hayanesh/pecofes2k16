...
public class FashionParade extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fasion_parade);
        ...
        title = (TextView)findViewById(R.id.fashion_title);
        topic = (TextView)findViewById(R.id.fashion_topic);
        description = (TextView)findViewById(R.id.fashion_description);
        price = (TextView)findViewById(R.id.fashion_price);
        priceamt = (TextView)findViewById(R.id.fashion_priceamt);
        ...
        listView = (ListView)findViewById(R.id.fashion_abouttopic);
        String[] rules = getResources().getStringArray(R.array.fashion_rules);
