...
public class MrPec extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mr_pec);
        ...
        title = (TextView)findViewById(R.id.mrpec_title);
        topic = (TextView)findViewById(R.id.mrpec_topic);
        description = (TextView)findViewById(R.id.mrpec_description);
        price = (TextView)findViewById(R.id.mrpec_price);
        priceamt = (TextView)findViewById(R.id.mrpec_priceamt);
        ...
        listView = (ListView)findViewById(R.id.mrpec_abouttopic);
        String[] rules = getResources().getStringArray(R.array.mrpec_rules);
