...
public class Variety extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title = (TextView)findViewById(R.id.variety_title);
        topic = (TextView)findViewById(R.id.variety_topic);
        description = (TextView)findViewById(R.id.variety_description);
        price = (TextView)findViewById(R.id.variety_price);
        priceamt = (TextView)findViewById(R.id.variety_priceamt);
        ...
        listView = (ListView)findViewById(R.id.variety_abouttopic);
        String[] rules = getResources().getStringArray(R.array.variety_rules);
        ...
        try{
            Glide.with(this).load(R.drawable.variety).into((ImageView)findViewById(R.id.variety_thumbnail));
        }catch (Exception e)
        {
            e.printStackTrace();
        }
