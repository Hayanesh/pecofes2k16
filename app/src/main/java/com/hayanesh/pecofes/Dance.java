...
public class Dance extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title = (TextView)findViewById(R.id.dance_title);
        topic = (TextView)findViewById(R.id.dance_topic);
        description = (TextView)findViewById(R.id.dance_description);
        price = (TextView)findViewById(R.id.dance_price);
        priceamt = (TextView)findViewById(R.id.dance_priceamt);
        ...
        listView = (ListView)findViewById(R.id.dance_abouttopic);
        String[] rules = getResources().getStringArray(R.array.dance_rules);
        ...
        try{
            Glide.with(this).load(R.drawable.dance).into((ImageView)findViewById(R.id.dance_thumbnail));
        }catch (Exception e)
        {
            e.printStackTrace();
        }
